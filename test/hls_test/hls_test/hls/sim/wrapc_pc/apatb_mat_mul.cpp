...
#define AUTOTB_TVOUT_in1 "../tv/cdatafile/c.mat_mul.autotvout_in1.dat"
#define AUTOTB_TVIN_in2 "../tv/cdatafile/c.mat_mul.autotvin_in2.dat"
#define AUTOTB_TVOUT_in2 "../tv/cdatafile/c.mat_mul.autotvout_in2.dat"
...
// tvout file define:
#define AUTOTB_TVOUT_PC_out_r "../tv/rtldatafile/rtl.mat_mul.autotvout_out_r.dat"
...
extern "C"
void mat_mul_hw_stub_wrapper(void*, void*, void*);

extern "C"
void apatb_mat_mul_hw(void* __xlx_apatb_param_in1, void* __xlx_apatb_param_in2, void* __xlx_apatb_param_out_r)
{
  ...
  static hls::sim::Memory<hls::sim::Reader, hls::sim::Writer> port0 {
    ...
    .owriter = nullptr,
#ifdef USE_BINARY_TV_FILE
    .iwriter = new hls::sim::Output(AUTOTB_TVIN_in1),
#else
  ...
  static hls::sim::Memory<hls::sim::Reader, hls::sim::Writer> port1 {
    ...
    .owriter = nullptr,
#ifdef USE_BINARY_TV_FILE
    .iwriter = new hls::sim::Output(AUTOTB_TVIN_in2),
#else
  ...
  try {
    ...
    mat_mul_hw_stub_wrapper(__xlx_apatb_param_in1, __xlx_apatb_param_in2, __xlx_apatb_param_out_r);
