...
extern "C" {
    void kernel_phi_mlp(
        ...
        fixed32_14 weight_1[INTERMEDIATE_SIZE * HIDDEN_SIZE],
        fixed32_14 bias_1[INTERMEDIATE_SIZE],
        fixed32_14 weight_2[HIDDEN_SIZE * INTERMEDIATE_SIZE],
        fixed32_14 bias_2[HIDDEN_SIZE]
    ) {
        ...
        fixed32_14 local_w[FIRST_BLOCK_SIZE * HIDDEN_SIZE];
