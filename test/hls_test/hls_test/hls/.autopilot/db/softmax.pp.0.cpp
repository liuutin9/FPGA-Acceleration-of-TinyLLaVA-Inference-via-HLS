# 1 "C:/Users/liuut/Desktop/Project/modules/softmax.cpp"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 396 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "C:/Users/liuut/Desktop/Project/modules/softmax.cpp" 2
...
# 2 "C:/Users/liuut/Desktop/Project/modules/softmax.cpp" 2
...
#pragma HLS INTERFACE port=in mode=bram
 ...
 VITIS_LOOP_9_1: for (int i = 0; i < M; i++) {
        int max_val = in[i][0];
        maxval_1D(&max_val, in[i]);
        int sum_exp = 0;
        VITIS_LOOP_13_2: for (int j = 0; j < N; j++) {
            out[i][j] = exp(in[i][j] - max_val);
            sum_exp += out[i][j];
        }
        VITIS_LOOP_17_3: for (int j = 0; j < N; j++) {
            out[i][j] /= sum_exp;
        }
    }
}
