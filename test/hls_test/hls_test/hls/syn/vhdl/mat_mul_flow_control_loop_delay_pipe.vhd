...
entity mat_mul_flow_control_loop_delay_pipe is
port (
    ap_clk             : in  std_logic;
    ap_rst             : in  std_logic;
...
end entity mat_mul_flow_control_loop_delay_pipe;

architecture behav of mat_mul_flow_control_loop_delay_pipe is
