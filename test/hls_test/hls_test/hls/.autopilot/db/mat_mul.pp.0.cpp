...
__attribute__((sdx_kernel("mat_mul", 0))) void mat_mul(int in1[4][4], int in2[4][4], int out[4][4]) {
#line 1 "directive"
#pragma HLSDIRECTIVE TOP name=mat_mul
# 3 "mat_mul.cpp"
...
#pragma HLS INTERFACE port=out mode=bram
 ...
 VITIS_LOOP_9_1: for (int i = 0; i < 4; i++) {
        VITIS_LOOP_10_2: for (int j = 0; j < 4; j++) {
            int sum = 0;
            VITIS_LOOP_12_3: for (int k = 0; k < 4; k++) {
