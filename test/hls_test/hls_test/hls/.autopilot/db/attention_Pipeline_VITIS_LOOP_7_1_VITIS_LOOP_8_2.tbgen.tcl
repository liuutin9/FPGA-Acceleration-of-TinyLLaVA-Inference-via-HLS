set moduleName attention_Pipeline_VITIS_LOOP_7_1_VITIS_LOOP_8_2
set isTopModule 0
...
set cdfgNum 8
set C_modelName {attention_Pipeline_VITIS_LOOP_7_1_VITIS_LOOP_8_2}
...
dict set ap_memory_interface_dict k_t { MEM_WIDTH 32 MEM_SIZE 24 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
set C_modelArgList {
	{ k int 32 regular {bram 6 { 1 3 } 1 1 }  }
	{ k_t int 32 regular {array 6 { 0 3 } 0 1 }  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "k", "interface" : "bram", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "k_t", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ k_Addr_A sc_out sc_lv 32 signal 0 } 
	{ k_EN_A sc_out sc_logic 1 signal 0 } 
	{ k_WEN_A sc_out sc_lv 4 signal 0 } 
	{ k_Din_A sc_out sc_lv 32 signal 0 } 
	{ k_Dout_A sc_in sc_lv 32 signal 0 } 
	{ k_t_address0 sc_out sc_lv 3 signal 1 } 
	{ k_t_ce0 sc_out sc_logic 1 signal 1 } 
	{ k_t_we0 sc_out sc_logic 1 signal 1 } 
	{ k_t_d0 sc_out sc_lv 32 signal 1 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "k_t_we0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "k_t", "role": "we0" }} , 
 	{ "name": "k_t_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "k_t", "role": "d0" }}  ]}
...
set Spec2ImplPortList { 
	k { bram {  { k_Addr_A MemPortADDR2 1 32 }  { k_EN_A MemPortCE2 1 1 }  { k_WEN_A MemPortWE2 1 4 }  { k_Din_A MemPortDIN2 1 32 }  { k_Dout_A MemPortDOUT2 0 32 } } }
	k_t { ap_memory {  { k_t_address0 mem_address 1 3 }  { k_t_ce0 mem_ce 1 1 }  { k_t_we0 mem_we 1 1 }  { k_t_d0 mem_din 1 32 } } }
}
