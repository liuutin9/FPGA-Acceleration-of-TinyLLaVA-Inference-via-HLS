...
// ==============================================================
`timescale 1ns/1ps
module attention_control_s_axi
#(parameter
...
always @(posedge ACLK) begin
    if (ARESET)
        ...
        if (w_hs && waddr == ADDR_D_K_DATA_0)
            int_d_k[31:0] <= (WDATA[31:0] & wmask) | (int_d_k[31:0] & ~wmask);
    end
end
