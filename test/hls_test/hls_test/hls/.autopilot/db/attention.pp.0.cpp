# 1 "C:/Users/liuut/Desktop/Project/modules/attention.cpp"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 396 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "C:/Users/liuut/Desktop/Project/modules/attention.cpp" 2
# 1 "C:/Users/liuut/Desktop/Project/modules/matadd.cpp" 1
...
#pragma HLS INTERFACE port=in2 mode=bram
 ...
 VITIS_LOOP_11_1: for (int i = 0; i < M; i++) {
        VITIS_LOOP_12_2: for (int j = 0; j < N; j++) {
            out[i][j] = in1[i][j] + in2[i][j];
        }
    }
}
# 2 "C:/Users/liuut/Desktop/Project/modules/attention.cpp" 2
# 1 "C:/Users/liuut/Desktop/Project/modules/matmul.cpp" 1
...
#pragma HLS INTERFACE port=in2 mode=bram
 ...
 VITIS_LOOP_8_1: for (int i = 0; i < M; i++) {
        VITIS_LOOP_9_2: for (int j = 0; j < N; j++) {
            int sum = 0;
            VITIS_LOOP_11_3: for (int k = 0; k < K; k++) {
...
# 3 "C:/Users/liuut/Desktop/Project/modules/attention.cpp" 2
# 1 "C:/Users/liuut/Desktop/Project/modules/transpose.cpp" 1
template <int M, int N>
...
#pragma HLS INTERFACE port=in mode=bram
 ...
 VITIS_LOOP_7_1: for (int i = 0; i < M; i++) {
        VITIS_LOOP_8_2: for (int j = 0; j < N; j++) {
            out[j][i] = in[i][j];
        }
    }
}
# 4 "C:/Users/liuut/Desktop/Project/modules/attention.cpp" 2
...
# 42 "C:/Xilinx/Vitis/2024.2/tps/mingw/8.3.0/win64.o/nt\\lib\\gcc\\x86_64-w64-mingw32\\8.3.0\\include\\c++\\cmath" 2 3
...
# 261 "C:/Xilinx/Vitis/2024.2/tps/mingw/8.3.0/win64.o/nt\\lib\\gcc\\x86_64-w64-mingw32\\8.3.0\\include\\c++\\bits/cpp_type_traits.h" 3
...
# 43 "C:/Xilinx/Vitis/2024.2/tps/mingw/8.3.0/win64.o/nt\\lib\\gcc\\x86_64-w64-mingw32\\8.3.0\\include\\c++\\cmath" 2 3
...
# 44 "C:/Xilinx/Vitis/2024.2/tps/mingw/8.3.0/win64.o/nt\\lib\\gcc\\x86_64-w64-mingw32\\8.3.0\\include\\c++\\cmath" 2 3
...
#pragma pack(pop)
# 14 "C:/Xilinx/Vitis/2024.2/tps/mingw/8.3.0/win64.o/nt\\x86_64-w64-mingw32\\include\\math.h" 2 3
...
# 270 "C:/Xilinx/Vitis/2024.2/tps/mingw/8.3.0/win64.o/nt\\x86_64-w64-mingw32\\include\\math.h" 3
  struct _complex {
    double x;
    double y;
  };
...
# 297 "C:/Xilinx/Vitis/2024.2/tps/mingw/8.3.0/win64.o/nt\\x86_64-w64-mingw32\\include\\math.h" 3
...
# 327 "C:/Xilinx/Vitis/2024.2/tps/mingw/8.3.0/win64.o/nt\\x86_64-w64-mingw32\\include\\math.h" 3
...
# 39 "C:/Xilinx/Vitis/2024.2/tps/mingw/8.3.0/win64.o/nt\\lib\\gcc\\x86_64-w64-mingw32\\8.3.0\\include\\c++\\bits/std_abs.h" 2 3
...
# 48 "C:/Xilinx/Vitis/2024.2/tps/mingw/8.3.0/win64.o/nt\\lib\\gcc\\x86_64-w64-mingw32\\8.3.0\\include\\c++\\cmath" 2 3
...
# 5 "C:/Users/liuut/Desktop/Project/modules/attention.cpp" 2

__attribute__((sdx_kernel("attention", 0))) void attention(
    int out[2][3],
    int q[2][3],
    int k[2][3],
    int v[2][3],
...
#line 1 "directive"
#pragma HLSDIRECTIVE TOP name=attention
# 12 "C:/Users/liuut/Desktop/Project/modules/attention.cpp"
...
#pragma HLS INTERFACE port=v mode=bram
 ...
 int k_t[3][2];
    ...
    int qk_scaled[2][2];
    VITIS_LOOP_25_1: for (int i = 0; i < 2; i++) {
        VITIS_LOOP_26_2: for (int j = 0; j < 2; j++) {
            qk_scaled[i][j] = qk[i][j] / d_k;
        }
    }
    int qk_scaled_exp[2][2];
    VITIS_LOOP_31_3: for (int i = 0; i < 2; i++) {
        VITIS_LOOP_32_4: for (int j = 0; j < 2; j++) {
            qk_scaled_exp[i][j] = exp(qk_scaled[i][j]);
        }
    }
