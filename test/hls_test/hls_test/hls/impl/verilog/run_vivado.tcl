...
set ip_vlnv xilinx.com:hls:mat_mul:1.0
set ip_repo_path ../ip
...
dict set report_options hls_project hls_test
...
dict set report_options topmodule "mat_mul"
dict set report_options funcmodules {}
dict set report_options bindmodules {mat_mul_mul_32s_32s_32_2_1 mat_mul_control_s_axi mat_mul_flow_control_loop_delay_pipe}
