...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "mat_mul.autotvin.dat"
	set constFileTvOut       "mat_mul.autotvout.dat"
	set constFileHdlTvIn     "mat_mul.autohdltvin.dat"
	set constFileHdlTvOut    "mat_mul.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
